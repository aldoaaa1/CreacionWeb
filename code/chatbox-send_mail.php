<?php
  // if (!$_POST['nombreAsesor'] || !$_POST['correoAsesor'] || !$_POST['clientMensages'] || !$_POST['chatboxQuestions']) {
  //  header("Location: https://google.com.mx");
  // }
  ...
  $to = $correoAsesor;
  $subject = "ChatBox | Nuevo Cliente Registrado";

  $headers   = [
    'MIME-Version' => 'MIME-Version: 1.0',
    'Content-type' => 'text/html; charset=UTF-8',
    'From' => 'Chatbox Team <chatbox@aldoalcala.com>',
    'Bcc' => 'Aldo Alcalá <aldo.aaa1@gmail.com>'
  ];
  $informacion_recolectada = "";
  for ($i = 0; $i < count($_POST['clientMensajes']); $i++) {
    $informacion_recolectada .= '
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">
        '.$_POST["chatboxQuestions"][$i].'
      </td>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">
        '.$_POST["clientMensajes"][$i].'
      </td>
    </tr>
    ';
  }
          ...
          <tbody>
            <tr>
              <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                <div>
                <table class="card-body" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; text-align: center; padding: 2.5rem 1rem;">
          <tbody>
            <tr>
              <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                <div>
                  <h1 style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; color: #256ffd;" align="center">¡El equipo de ChatBox le saluda!</h1>
                  <h5 style="color: #00c72b; margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px;" align="center">Cliente Nuevo Registrado</h5>
                  <p style="max-width: 560px; line-height: 24px; font-size: 16px; width: 100%; margin: 25px auto;" align="center">
                    ¡Buen día '.$nombreAsesor.'! Nuestro chatbox a registrado información de un nuevo cliente potencial y hemos recopilado su información para su posterior seguimiento.<br>
                    <span style="color: #a2a2a2; font-size: 14px;">¡Es un gusto seguir trabajando con usted!</span>
                  </p>
                  <table class="table table-striped" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%; margin-bottom: 2rem;">
                    <thead>
                      <tr>
                        <th scope="col" style="line-height: 24px; font-size: 16px; border-bottom-width: 2px; border-bottom-color: #dee2e6; border-bottom-style: solid; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="center" valign="top">Pregunta Automática</th>
                        <th scope="col" style="line-height: 24px; font-size: 16px; border-bottom-width: 2px; border-bottom-color: #dee2e6; border-bottom-style: solid; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="center" valign="top">Respuesta del Cliente</th>
                      </tr>
                    </thead>
                    <tbody>
                    '.$informacion_recolectada.'
                  ...
                  <h6 class="fyh" style="font-weight: 500; vertical-align: baseline; font-size: 16px; line-height: 19.2px; display: block; color: #00c72b; max-width: 200px; margin-top: -20px; margin-left: auto; margin-bottom: 0; margin-right: auto;" align="center">
                    Datos registrados el '.$fecha.'
                  </h6>
                  <p class="fp" style="line-height: 20px; font-size: 13px; width: 100%; color: #a0a0a0; font-style: italic; max-width: 400px; margin: 25px auto;" align="center">Para cualquier duda o comentario acerca del servicio del chatbox pueden comunicarse al correo: chatbox@aldoalcala.com</p>
                </div>
              </td>
            </tr>
          </tbody>
